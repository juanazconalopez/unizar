...
export function SeasonsView({ embedded = false, hideEmbeddedTitle = false, seasons, competitions = [], teams = [], teamCoaches = [], profiles, profilePrivateDetails = [], memberships, holidays: providedHolidays, onCreate, onDelete, onUpdate, onSaveHolidays, onCreateCompetition, onDeleteCompetition, onSetDefaultCompetition, onUpdateCompetition, onCreateTeam, onUpdateTeam, onDeleteTeam, onAssignPlayerTeam, onAssignTeamCoach }: {
  ...
  /** Compatibilidad con llamadas antiguas; la gestión manual se ha retirado de la interfaz. */
  ...
  const [teamSeason, setTeamSeason] = useState<Season | null>(null)
...
function SeasonCard({ season, profiles, profilePrivateDetails, memberships, holidayCount, competitionCount, onEdit, onHolidays, onCompetitions, onTeams }: {
  season: Season
  profiles: Profile[]
  profilePrivateDetails: ProfilePrivateDetails[]
  memberships: SeasonPlayer[]
  ...
  return (
    <article className="season-card">
      ...
      <div className="season-card-actions">
        <button className="secondary-button" onClick={onTeams}><Icon name="users" size={17} />Gestionar equipos</button>
