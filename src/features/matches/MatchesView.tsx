...
export function MatchesView({ availability, isOwner, lineups, matches, memberships, profiles, seasons, userId, onDelete, onLoadMonth, onSaveAvailability, onSaveLineup, onSaveMatch }: {
